...
public class Connexion {
    private static final String URL = "jdbc:mysql://localhost:3306/projet_java"; // Nom de la BDD
    private static final String UTILISATEUR = "root";  // Modifie si nécessaire
    private static final String MOT_DE_PASSE = "";  // Mets ton mot de passe MySQL si nécessaire
